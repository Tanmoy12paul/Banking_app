...
def get_db_connection():
    return mysql.connector.connect(
        ...
        password="799007",  # Your MySQL password
        database="bank_nndb"
    )
...
csv_file_path = r"C:\Users\Tanmoy\OneDrive\Desktop\projects\BDA_Banking (1)\Users_Data_Cleaned.csv"  # Make sure this path is correct
